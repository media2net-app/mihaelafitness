              ...
              <tbody>
                {courses.map((course) => (
                  <tr key={course.id} className="dashboard-table__row--clickable">
                    <td>
                      <Link href={`/${client.id}/mindset/${course.id}`} style={{ textDecoration: 'none', color: 'inherit', display: 'block' }}>
                    ...
                    <td>
                      <div className="dashboard-actions">
                        <Link href={`/${client.id}/mindset/${course.id}`} className="dashboard-action-btn" title="Bekijken">
                          <Video size={16} />
                        </Link>
