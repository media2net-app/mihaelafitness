  ...
  return (
    <div className="page-admin">
      <div className="page-header">
        <div>
          <Link href={`/${client.id}/mindset`} className="dashboard-card__link" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', marginBottom: '1rem' }}>
            <ArrowLeft size={16} />
      ...
      <div className="page-section">
        <div className="page-card">
          <div className="dashboard-card__header">
            ...
            <Link href={`/${client.id}/mindset/${cursus.id}/studenten`} className="dashboard-card__link">
              Bekijk alle →
            </Link>
          </div>
