  ...
  return (
    <div className="page-admin">
      <div className="page-header">
        <div>
          <Link href={`/${clientId}/voeding`} className="dashboard-card__link" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', marginBottom: '1rem' }}>
            <ArrowLeft size={16} />
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "2rem" }}>
                ...
                <div style={{ display: "flex", gap: "1rem", marginTop: "1rem" }}>
                  <button
                    ...
                    className="btn btn--primary"
                    onClick={() => {
                      if (aiOptions.soortMaaltijden.length === 0) {
                        alert("Selecteer minimaal één soort maaltijd");
                        return;
                      }
                      ...
                      setTimeout(() => {
                        ...
                        const aiPlanParams = new URLSearchParams({
                          ...
                          soortMaaltijden: aiOptions.soortMaaltijden.join(","),
                        ...
                        // Stuur door naar AI plan pagina
                        router.push(`/${clientId}/voeding/ai-plan?${aiPlanParams.toString()}`);
                      }, 2000);
                    }}
                    disabled={aiOptions.soortMaaltijden.length === 0}
                    style={{
                      opacity: aiOptions.soortMaaltijden.length === 0 ? 0.5 : 1,
                      cursor: aiOptions.soortMaaltijden.length === 0 ? "not-allowed" : "pointer",
                    }}
                  >
                    <Sparkles size={16} />
                    Generate Plan
