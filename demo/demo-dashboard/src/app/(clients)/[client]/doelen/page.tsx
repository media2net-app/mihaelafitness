              ...
              <tbody>
                {doelen.map((doel) => (
                  <tr key={doel.id} className="dashboard-table__row--clickable">
                    <td>
                      <Link href={`/${client.id}/doelen/${doel.id}`} style={{ textDecoration: 'none', color: 'inherit', display: 'block' }}>
                    ...
                    <td>
                      <div className="dashboard-actions">
                        <Link href={`/${client.id}/doelen/${doel.id}`} className="dashboard-action-btn" title="Bekijken">
