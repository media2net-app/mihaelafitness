...
import { rimatoDashboardData, neumannDashboardData } from "@/lib/dashboard-data";
import { BarChart3, Users, Euro, CheckCircle2, Star, TrendingUp, Factory, Droplets, Building2, Home, Users2, Trees, Laptop, Hospital, UserCog, User, MapPin, Clock } from "lucide-react";
...
export default async function DashboardPage({ params }: DashboardPageProps) {
        ...
        <div className="dashboard-grid">
          ...
          <section className="dashboard-card dashboard-card--large">
            <div className="dashboard-card__header">
              ...
              <a href={`/${client.id}/projects`} className="dashboard-card__link">
                Bekijk alle →
              </a>
            </div>
          ...
          <section className="dashboard-card">
            <div className="dashboard-card__header">
              <h2>Klanten CRM</h2>
              <a href={`/${client.id}/clients`} className="dashboard-card__link">
                Bekijk alle →
              </a>
            </div>
        ...
        <div className="dashboard-grid">
          ...
          <section className="dashboard-card">
            <div className="dashboard-card__header">
              ...
              <a href={`/${client.id}/schedule`} className="dashboard-card__link">
                Bekijk agenda →
              </a>
            </div>
          ...
          <section className="dashboard-card">
            <div className="dashboard-card__header">
              ...
              <a href={`/${client.id}/reviews`} className="dashboard-card__link">
                Bekijk alle →
              </a>
            </div>
  ...
  return (
    <div className="dashboard-grid">
      <section className="dashboard-card dashboard-card--primary">
        <h2>Welkom bij {client.name}</h2>
        <p className="dashboard-intro">{client.summary}</p>
      </section>
    </div>
  );
}
