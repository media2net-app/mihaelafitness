              ...
              <tbody>
                {programma.map((prog) => (
                  <tr key={prog.id} className="dashboard-table__row--clickable">
                    <td>
                      <Link href={`/clients/${client.id}/trainingen/${prog.id}`} style={{ textDecoration: 'none', color: 'inherit', display: 'block' }}>
                    ...
                    <td>
                      <div className="dashboard-actions">
                        <Link href={`/clients/${client.id}/trainingen/${prog.id}`} className="dashboard-action-btn" title="Bekijken">
                          <Activity size={16} />
                        </Link>
