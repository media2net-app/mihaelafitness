              ...
              <tbody>
                {trajecten.map((traject) => (
                  <tr key={traject.id} className="dashboard-table__row--clickable">
                    <td>
                      <Link href={`/clients/${client.id}/revalidatie/${traject.id}`} style={{ textDecoration: 'none', color: 'inherit', display: 'block' }}>
                    ...
                    <td>
                      <div className="dashboard-actions">
                        <Link href={`/clients/${client.id}/revalidatie/${traject.id}`} className="dashboard-action-btn" title="Bekijken">
                          <FileText size={16} />
                        </Link>
