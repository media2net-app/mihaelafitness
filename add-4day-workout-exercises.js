...
async function add4DayWorkoutExercises() {
  try {
    console.log('🚀 Starting to add 4-Day Workout Plan exercises to database...');

    // Get the "4-Days Workout Plan" workout
    const workoutsResponse = await fetch(`${BASE_URL}/api/workouts`);
    const workouts = await workoutsResponse.json();
    
    const workout = workouts.find(w => w.name === '4-Days Workout Plan');
    
    if (!workout) {
      console.error('❌ 4-Days Workout Plan not found');
      return;
    }
    ...
    const workoutExercises = {
      1: [ // Monday - Legs (60 min)
        ...
        { name: "Clamshells", sets: 2, reps: "12 each side", weight: "bodyweight", restTime: "30 sec" },
        // Main Workout (40 min)
        { name: "Barbell back squat", sets: 4, reps: "12", weight: "barbell", restTime: "60-90 sec" },
        { name: "Romanian deadlift", sets: 4, reps: "12", weight: "barbell", restTime: "60-90 sec" },
        { name: "Walking lunges", sets: 4, reps: "12 each leg", weight: "bodyweight", restTime: "60-90 sec" },
      ...
      2: [ // Tuesday - Back / Triceps / Abs (60 min)
        ...
        { name: "Overhead dumbbell tricep extension", sets: 4, reps: "12", weight: "dumbbell", restTime: "60-90 sec" },
        { name: "Face pulls", sets: 4, reps: "12", weight: "cable", restTime: "60-90 sec" },
        // Abs (5-10 min)
        ...
        { name: "Hanging knee raises", sets: 3, reps: "12", weight: "bodyweight", restTime: "30 sec" }
      ],
      3: [ // Thursday - Glutes (60 min)
        // Warm-Up (5 min)
        { name: "Glute bridges", sets: 2, reps: "12", weight: "bodyweight", restTime: "30 sec" },
        { name: "Bodyweight squats", sets: 2, reps: "15", weight: "bodyweight", restTime: "30 sec" },
        { name: "Leg swings", sets: 2, reps: "10 each leg", weight: "bodyweight", restTime: "30 sec" },
        ...
        { name: "Glute bridge march", sets: 4, reps: "12 each leg", weight: "bodyweight", restTime: "60-90 sec" },
        // Finisher (5-10 min)
        { name: "Sumo squat pulses", sets: 3, reps: "15", weight: "bodyweight", restTime: "30 sec" }
      ],
      4: [ // Friday - Chest / Shoulders / Biceps / Abs (60 min)
        // Warm-Up (5 min)
        ...
        { name: "Light dumbbell chest press", sets: 2, reps: "12", weight: "light dumbbells", restTime: "30 sec" },
        // Activation (5 min)
        { name: "Band pull-aparts", sets: 2, reps: "12", weight: "resistance band", restTime: "30 sec" },
        { name: "Push-ups on knees", sets: 2, reps: "10", weight: "bodyweight", restTime: "30 sec" },
        // Main Workout (40 min)
        { name: "Dumbbell chest press", sets: 4, reps: "12", weight: "dumbbells", restTime: "60-90 sec" },
        ...
        if (dbExercise) {
          const response = await fetch(`${BASE_URL}/api/workout-exercises`, {
            ...
            body: JSON.stringify({
              ...
              notes: `4-Day Workout Plan - Day ${day}`
            })
          });
